...
import com.yasuchenya.xml.parser.CrystalDOMBuilder;
...
public class CrystalDOMBuilderTest {
    ...
    public void testGetCrystals() throws ProjectException {
        ...
        CrystalDOMBuilder dom = new CrystalDOMBuilder();
        dom.buildSetCrystals(FILE_PATH);
        Set<Crystal> expected = new HashSet<>();
        expected.add(EXPECTED_GEM);
        Set<Crystal> actual = dom.getCrystals();
        if(actual.isEmpty()){
