...
import com.yasuchenya.xml.parser.CrystalSAXBuilder;
...
public class CrystalSAXBuilderTest {
    ...
    public void testGetCrystals() throws ProjectException {
        ...
        CrystalSAXBuilder sax = new CrystalSAXBuilder();
        sax.buildSetCrystals(FILE_PATH);
        Set<Crystal> expected = new HashSet<>();
        expected.add(EXPECTED_GEM);
        Set<Crystal> actual = sax.getCrystals();
        if(actual.isEmpty()){
